  ...
  return (
    ...
    <section className="w-full bg-[#1B1E23] pt-40 pb-16 px-6 md:px-12">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
        <h1 className="font-normal text-center text-[36px] md:text-[48px] lg:text-[58px] leading-tight text-white">
          {heroContent.title}
        </h1>

        {/* Paragraph */}
        <p className="mt-6 text-center text-[20px] md:text-[14px] text-white max-w-[620px] mx-auto">
        ...
        {/* Hero Image */}
        <Image
          src="images/hero-img.svg" // replace with your asset
